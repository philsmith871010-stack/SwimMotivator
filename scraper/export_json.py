...
from .config import DB_PATH, JSON_DIR, STROKE_NAMES, COSTA_TIREFS
...
def export_per_swimmer(conn: sqlite3.Connection) -> None:
    ...
    tirefs = [str(t) for t in COSTA_TIREFS]
    # Also include any swimmer in the swimmers table
...
def export_rankings_by_level(conn: sqlite3.Connection) -> None:
    ...
    costa_set = set(str(t) for t in COSTA_TIREFS)
